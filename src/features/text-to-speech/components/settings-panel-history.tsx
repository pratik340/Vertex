    ...
    return(
     <div className="flex h-full flex-col items-center justify-center gap-2 p-8">
        ...
        <p className="max-w-48 text-center text-xs text-muted-foreground">
            Your generated speech will appear here. Start creating to see your history!
        </p>
     </div>
     );
    }
      return(
        <div className="flex flex-col gap-1 p-2">
            {generations.map((generation)=>(
                  ...
                  key={generation.id}
                  className="flex items-center gap-3 rounded-lg p-3 text-left transitions-colors hover:bg-muted"
                  >
